	...
	public frmPaquetes() {
		...
		btnRegistrar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				cr.create(Integer.parseInt(txtDestino.getText()), Integer.parseInt(txtOrigen.getText()),
						...
						txtObservaciones.getText(), Integer.parseInt(txtPromotores.getText()),
		...
		btnConsultar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				cr.read(Integer.parseInt(txtcodigo.getText()), txtDestino, txtOrigen, txtHoraVenta, txtHoraVenta,
						txtSalida, txtEjecucion, txtObservaciones, txtPromotores, txtCliente, txtAgencia, txtVehiculo,
						txtMedio, txtPrecio);
		...
		btnConsultar.setBounds(188, 374, 35, 29);
