	...
	public frmVehiculos() {
		...
		btnRegistrar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				cr.create(txtPlaca.getText(), txtMarca.getText(), Integer.parseInt(txtPuesto.getText()),
		...
		btnConsultar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				// Consultar datos
				cr.read(Integer.parseInt(txtidvehiculo.getText()), txtPlaca, txtMarca, txtPuesto, txtModelo, txtMotor,
						txtCategoria, txtIdTipoTransporte);
			}
		});
