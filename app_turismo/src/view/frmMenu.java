...
public class frmMenu extends JFrame {
	...
	public frmMenu() {
		...
		btnIrAgencias.setBounds(31, 71, 64, 64);
		...
		lblClientes.setBounds(125, 141, 69, 20);
		...
		btnIrClientes.setBounds(125, 71, 64, 64);
		...
		lblCompanias.setBounds(228, 141, 70, 20);
		...
		btnIrCompanias.setBounds(228, 71, 64, 64);
		...
		lblMedios.setBounds(31, 254, 51, 20);
		...
		btnIrMedios.setBounds(31, 184, 64, 64);
		...
		lblOperadores.setBounds(459, 253, 75, 20);
		...
		btnIrOperadores.setBounds(465, 184, 64, 64);
		...
		lblPaquetes.setBounds(337, 137, 70, 20);
		...
		btnIrPaquetes.setBounds(337, 71, 64, 64);
		...
		lblPromotores.setBounds(465, 137, 75, 20);
		...
		btnIrPromotores.setBounds(465, 70, 64, 64);
		contentPane.add(btnIrPromotores);

		JLabel lblTipoMedio = new JLabel("TIPOS DE MEDIOS");
		lblTipoMedio.setHorizontalTextPosition(SwingConstants.CENTER);
		lblTipoMedio.setHorizontalAlignment(SwingConstants.CENTER);
		lblTipoMedio.setForeground(new Color(83, 48, 83));
		lblTipoMedio.setFont(new Font("Calibri", Font.BOLD, 12));
		lblTipoMedio.setBounds(108, 254, 99, 20);
		...
		btnTipoMedio.setBounds(125, 184, 64, 64);
		contentPane.add(btnTipoMedio);

		JLabel lblTipoTransporte = new JLabel("TIPOS TRANSPORTE");
		lblTipoTransporte.setHorizontalTextPosition(SwingConstants.CENTER);
		lblTipoTransporte.setHorizontalAlignment(SwingConstants.CENTER);
		lblTipoTransporte.setForeground(new Color(83, 48, 83));
		lblTipoTransporte.setFont(new Font("Calibri", Font.BOLD, 12));
		lblTipoTransporte.setBounds(319, 252, 99, 20);
		...
		btnIrTransporte.setBounds(337, 188, 64, 64);
		contentPane.add(btnIrTransporte);

		JLabel lblVehiculo = new JLabel("VEHICULOS");
		lblVehiculo.setFont(new Font("Calibri", Font.BOLD, 12));
		lblVehiculo.setForeground(new Color(83, 48, 83));
		lblVehiculo.setHorizontalAlignment(SwingConstants.CENTER);
		lblVehiculo.setBounds(228, 254, 70, 20);
		...
		btnIrVehiculos.setBounds(228, 183, 64, 64);
